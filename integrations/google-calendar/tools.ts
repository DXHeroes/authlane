...
export interface GoogleCalendarTool {
  name: string;
  description: string;
  inputSchema: {
    type: 'object';
...
const googleCalendarTools: GoogleCalendarTool[] = [
  {
 ...
 */
export function getToolsMCP(): { tools: GoogleCalendarTool[] } {
  return { tools: googleCalendarTools };
}
...
export function getToolsOpenAI(): {
  ...
  return {
    functions: googleCalendarTools.map((tool) => ({
      name: tool.name,
