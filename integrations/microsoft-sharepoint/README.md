# @authlane/integration-microsoft-sharepoint

Microsoft Drive (SharePoint) canonical tool definitions and SaaS-runtime execution support for Authlane.

```bash
pnpm add @authlane/integration-microsoft-sharepoint
```
...
https://authlane.io/docs/integrations/microsoft-sharepoint
