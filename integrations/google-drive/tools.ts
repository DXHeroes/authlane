...
const googleDriveTools: GoogleDriveTool[] = [
  {
 ...
 */
export function getToolsMCP(): { tools: GoogleDriveTool[] } {
  return { tools: googleDriveTools };
}
...
export function getToolsOpenAI(): {
  ...
  return {
    functions: googleDriveTools.map((tool) => ({
      name: tool.name,
