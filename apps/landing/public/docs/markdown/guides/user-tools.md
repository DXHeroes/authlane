...
than Authlane hand-writes — GitHub declares eight tools in the catalog and the official endpoint
exposes around a hundred — so Authlane asks each one for its full catalogue and offers the rest
alongside the canonical tools.
