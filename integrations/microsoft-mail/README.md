# @authlane/integration-microsoft-mail

Microsoft Mail canonical tool definitions and SaaS-runtime execution support for Authlane.

```bash
pnpm add @authlane/integration-microsoft-mail
```
...
https://authlane.io/docs/integrations/microsoft-mail
