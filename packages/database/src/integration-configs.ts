...
export const CANONICAL_INTEGRATION_CONFIGS = {
  ...
  'microsoft-calendar': {
    ...
    default_scopes: ['offline_access', 'openid', 'profile', 'User.Read', 'Calendars.ReadWrite'],
    read_only_scopes: ['offline_access', 'openid', 'profile', 'User.Read', 'Calendars.Read'],
    docs_url: 'https://learn.microsoft.com/graph/api/resources/calendar',
    setup_guide_url: 'https://learn.microsoft.com/entra/identity-platform/quickstart-register-app',
  ...
  'microsoft-mail': {
    ...
    read_only_scopes: ['offline_access', 'openid', 'profile', 'User.Read', 'Mail.Read'],
