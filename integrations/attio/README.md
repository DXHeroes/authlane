# @authlane/integration-attio

Attio CRM canonical tool definitions and SaaS-runtime execution support for Authlane.

```bash
pnpm add @authlane/integration-attio
```
...
https://authlane.io/docs/integrations/attio
