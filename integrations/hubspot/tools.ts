...
const hubspotTools: HubSpotTool[] = [
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        properties: {
          type: 'array',
          items: { type: 'string' },
          description: 'Array of property names to include in response (e.g., ["firstname", "lastname", "email"])',
        },
        archived: {
          type: 'boolean',
        ...
        filterGroups: {
                ...
                items: {
                  ...
                  properties: {
                    ...
                    operator: {
                      ...
                      enum: ['EQ', 'NEQ', 'LT', 'LTE', 'GT', 'GTE', 'CONTAINS', 'NOT_CONTAINS', 'IN', 'NOT_IN', 'HAS_PROPERTY', 'NOT_HAS_PROPERTY'],
                    },
                    value: {
                      type: 'string',
          ...
          description: 'Filter groups for advanced filtering (filters within a group are AND, groups are OR)',
        },
        sorts: {
          type: 'array',
          items: {
  ...
  },
  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        closedate: {
          type: 'string',
          description: 'Expected close date in ISO 8601 format (YYYY-MM-DD or timestamp in milliseconds)',
        },
        dealtype: {
          type: 'string',
    ...
    inputSchema: {
      ...
      properties: {
        ...
        properties: {
          type: 'array',
          items: { type: 'string' },
          description: 'Array of property names to include in response (e.g., ["dealname", "amount", "dealstage"])',
        },
        archived: {
          type: 'boolean',
 ...
 */
export function getToolsMCP(): { tools: HubSpotTool[] } {
  return { tools: hubspotTools };
}
...
export function getToolsOpenAI(): {
  ...
  return {
    functions: hubspotTools.map((tool) => ({
      name: tool.name,
