...
export type BuiltInServiceId = 'airtable' | 'discord' | 'github' | 'gmail' | 'google-calendar' | 'google-drive' | 'hubspot' | 'jira' | 'linear' | 'notion' | 'pipedrive' | 'salesforce' | 'sentry' | 'slack' | 'stripe';
