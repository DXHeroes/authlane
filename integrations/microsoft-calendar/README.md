# @authlane/integration-microsoft-calendar

Microsoft Calendar canonical tool definitions and SaaS-runtime execution support for Authlane.

```bash
pnpm add @authlane/integration-microsoft-calendar
```
...
https://authlane.io/docs/integrations/microsoft-calendar
