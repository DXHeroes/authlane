# @authlane/integration-google-drive

Google Drive canonical tool definitions and SaaS-runtime execution support for Authlane.
...
https://authlane.io/docs/integrations/google-drive
