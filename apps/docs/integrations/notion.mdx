---
title: 'Notion'
description: 'Integration guide for Notion'
---
...
<Steps>
  <Step title="Create OAuth App">
    Create an OAuth application in Notion developer portal.
  </Step>
...
Tools available for Notion integration:

See `/integrations/notion/tools.ts` for complete list.
